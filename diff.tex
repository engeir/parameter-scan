...
%DIF ADD ./agujournaltemplate.tex                             Tue Aug 27 20:34:22 2024
...
\begin{document}
  ...
  \title{Radiative forcing by \DIFdelbegin \DIFdel{super-volcano }\DIFdelend \DIFaddbegin \DIFadd{supervolcano }\DIFaddend eruptions}
  ...
  \begin{keypoints}
    \item
    The linear \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend dependence on AOD breaks down for eruptions larger than Mt. Pinatubo
    \item
    The \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend to AOD ratio has a time-after-eruption dependence on eruption latitude
    \item
    Temperature and \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend peak values has a linear dependence and reaches an upper limit
  \end{keypoints}

  \begin{abstract}
    We investigate the climatic effects of volcanic eruptions spanning from Mt.\
    Pinatubo-sized events to \DIFdelbegin %DIFDELCMD < \annote[reviewer1]{super-volcanoes}{Here and throughout, be
...
\DIFdelend \DIFaddbegin \note[reviewer1]{L11} \DIFadd{supereruptions}\DIFaddend . The study is based on
    ...
    injections on stratospheric aerosol optical depth (AOD), \DIFdelbegin %DIFDELCMD < \annote[reviewer1]{effective radiative forcing
...
\DIFdelend \DIFaddbegin \note[reviewer1]{L15}
    \DIFadd{effective radiative forcing (ERF)}\DIFaddend , and global \DIFdelbegin \DIFdel{temperature }\DIFdelend \DIFaddbegin \DIFadd{mean surface temperature (GMST)
    }\DIFaddend anomalies. Unlike the traditional linear \DIFdelbegin \DIFdel{models used for smaller eruptions , our results reveal }\DIFdelend \DIFaddbegin \DIFadd{model used for eruptions up to Mt.\
    Pinatubo-size, }\DIFaddend a non-linear relationship \DIFdelbegin \DIFdel{between RF }\DIFdelend \DIFaddbegin \DIFadd{is typically found between ERF }\DIFaddend and AOD for
    larger eruptions. We \DIFdelbegin \DIFdel{also }\DIFdelend \DIFaddbegin \DIFadd{further }\DIFaddend uncover a notable time-dependent decrease in aerosol
    forcing efficiency \DIFaddbegin \DIFadd{(ERF normalised by AOD) }\DIFaddend across all eruption magnitudes during the
    first post-eruption year. In addition, the study reveals that \DIFdelbegin \DIFdel{larger }\DIFdelend \DIFaddbegin \DIFadd{the largest }\DIFaddend as
    compared to \DIFdelbegin \DIFdel{medium-sized }\DIFdelend \DIFaddbegin \DIFadd{Pinatubo-sized }\DIFaddend eruption events produce a delayed and sharper peak in
    AOD, and a longer-lasting \DIFdelbegin \DIFdel{temperature }\DIFdelend \DIFaddbegin \DIFadd{GMST }\DIFaddend response while the time evolution of \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend remains
    similar between the two eruption types. \DIFaddbegin \DIFadd{We find that the peak ERF approaches a
    limiting value, and that the peak GMST response follows linearly, effectively
    bounding the GMST to at most \(\sim\SI{-10}{\kelvin}\). }\DIFaddend When including the results
    of previous studies, we find that relating \ce{SO2} to any other parameter is
    inconsistent across models compared to the relationships between AOD, \DIFdelbegin \DIFdel{RF, and temperature
    anomaly}\DIFdelend \DIFaddbegin \DIFadd{ERF, and GMST}\DIFaddend .
    Thus, we expect the largest uncertainty in model codes to relate to
    \DIFdelbegin %DIFDELCMD < \annote[reviewer1]{the chemistry and physics of \protect\ce{SO2} evolution.}{The
...
\DIFdel{Finally, we find that the peak RF approaches a limiting value,
    ...
    temperature anomaly to at most \(\sim\SI{-12}{\kelvin}\)}\DIFdelend \DIFaddbegin \note[reviewer1]{L25} \DIFadd{the chemistry and physics of aerosol evolution}\DIFaddend .
  \end{abstract}
  ...
  large enough that \DIFdelbegin %DIFDELCMD < \annote[reviewer1]{the aerosols they emit}{Unfortunately for our
...
\DIFdelend \DIFaddbegin \note[reviewer1]{L31} \DIFadd{the aerosols that form from the gases they
  emit }\DIFaddend reach the stratosphere cause a cooling effect by reflecting sunlight. Typically,
  an eruption is measured by its impact on the opacity of the stratosphere and the
  change in the \DIFdelbegin %DIFDELCMD < \annote[reviewer1]{energy balance at the top of the
...
\DIFdelend \DIFaddbegin \note[reviewer1]{L33} \DIFadd{energy balance at the top of the atmosphere when
  ...
  still large enough to cause global climate effects. \DIFdelbegin \DIFdel{We find a clear }\DIFdelend \DIFaddbegin \DIFadd{In addition to a }\DIFaddend non-linear
  relationship \DIFdelbegin \DIFdel{for eruptions larger than the ones seen in the past two millennia. Our }\DIFdelend \DIFaddbegin \DIFadd{between energy imbalance and stratospheric opacity with increasing
  eruption magnitude, our }\DIFaddend simulations and supporting data shows that the eruption
  latitude significantly influences the development of the relationship \DIFdelbegin \DIFdel{between energy imbalance and stratospheric opacity
  }\DIFdelend with time after
  ...
  Effective radiative forcing (\DIFdelbegin \DIFdel{RF}\DIFdelend \DIFaddbegin \DIFadd{ERF}\DIFaddend ) and stratospheric aerosol optical depth (AOD) are
  crucial metrics representing the energy imbalance at top-of-the-atmosphere (TOA) \DIFdelbegin \DIFdel{and
  }\DIFdelend \DIFaddbegin \DIFadd{when
  ocean and sea-ice is held fixed and }\DIFaddend the stratospheric opacity due to aerosol
  scattering, respectively. \DIFdelbegin \DIFdel{They }\DIFdelend \DIFaddbegin \DIFadd{While calculation and estimation of forcing has not always
...
. Still, ERF and AOD }\DIFaddend are extensively used to quantify the impact of
  major volcanic eruptions\DIFdelbegin \DIFdel{. The }\DIFdelend \DIFaddbegin \DIFadd{, and a general }\DIFaddend assumption of a linear dependency of \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend on
  AOD is commonly adopted \cite{myhre2013,andersson2015}\DIFdelbegin \DIFdel{,
  and applying }\DIFdelend \DIFaddbegin \DIFadd{. Applying }\DIFaddend such a linear
  ...
  Yet, a wide spread in the estimated aerosol forcing efficiencies (\DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend normalised by
  AOD) exists among studies, spanning approximately from \(\sim
  \SI{-15}{\watt\metre^{-2}\ce{AOD}^{-1}}\) \cite{pitari2016b} to \DIFdelbegin %DIFDELCMD < \annote[reviewer1]{\protect\(\sim
...
\cite{myhre2013}}\hskip0pt%DIFAUXCMD
  ...
  \DIFadd{\(\sim \SI{-25}{\watt\metre^{-2}\ce{AOD}^{-1}}\) \mbox{%DIFAUXCMD
...
\cite{pinto1989,zhao1995}}\hskip0pt%DIFAUXCMD
  ...
  and reducing the \DIFdelbegin \DIFdel{RF}\DIFdelend \DIFaddbegin \DIFadd{ERF}\DIFaddend . As the conversion from \ce{SO2} to \ce{H2SO4}
  \DIFdelbegin %DIFDELCMD < \annote[reviewer1]{occurs over weeks}{the peak in AOD (at 500 nm) and thus the RF
...
\DIFdelend \DIFaddbegin \note[reviewer1]{L63} \DIFadd{occurs over weeks }\note[reviewer1]{L63}
...
\DIFdelend \DIFaddbegin \note[reviewer1]{L75} \DIFadd{Before the current era of significant anthropogenic climate
  forcing, volcanic eruptions were the primary forcing mechanism dictating Earth's
  climate variability during the Holocene period \mbox{%DIFAUXCMD
\cite{schurer2013}}\hskip0pt%DIFAUXCMD
}\DIFaddend . Despite this
...
\cite<e.g.~>[]{zanchettin2019,marshall2020,marshall2022,mcgraw2024}}\hskip0pt%DIFAUXCMD
  ...
  down to \DIFdelbegin %DIFDELCMD < \annote[reviewer1]{\protect\(\SI{-19.0(5)}{\watt\metre^{-2}\mathrm{AOD}^{-1}}\)}{I
...
\DIFdelend \DIFaddbegin \note[reviewer1]{L94}{\(\SI{-19.0(5)}{\watt\metre^{-2}\mathrm{AOD}^{-1}}\)}
  \note[reviewer1]{L95} \DIFadd{\mbox{%DIFAUXCMD
\cite{gregory2016} }\hskip0pt%DIFAUXCMD
and
  \(\SI{-18.3(10)}{\watt\metre^{-2}\mathrm{AOD}^{-1}}\) \mbox{%DIFAUXCMD
...
\DIFdelend \DIFaddbegin \DIFadd{maximum
  forcing and }\note[reviewer1]{L104} \DIFadd{annually injected \ce{SO2}}\DIFaddend , converging to
  \(\SI{-65}{\watt\metre^{-2}}\) (Eq.~\ref{eq:niemeier_exponential}). Even the
  \(100\times\) Mt.\ Pinatubo \DIFdelbegin \DIFdel{super-volcano }\DIFdelend \DIFaddbegin \DIFadd{supereruption }\DIFaddend simulation by \citeA{jones2005}, which
  obtained a peak \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend of \(\SI{-60}{\watt\metre^{-2}}\), is below the suggested limit of
...
%DIFDELCMD <     per TgSO2?} %%%
\DIFdelend \DIFaddbegin \note[reviewer1]{L107} \DIFadd{Moreover, \mbox{%DIFAUXCMD
\citeA{timmreck2010}
  }\hskip0pt%DIFAUXCMD
find a peak ERF anomaly of \(\SI{-18}{\watt\metre^{-2}}\) from a
  ...
  the function estimated by \mbox{%DIFAUXCMD
...
%DIFDELCMD <     eruptions.} %%%
\DIFdelend \DIFaddbegin \note[reviewer1]{L135} \DIFadd{Employing eruptions in the large to supereruption size enhances
  ...
  recent studies find this approach will }\DIFaddend yield incorrect results, both because the peak
  of the AOD \DIFdelbegin \DIFdel{may be too small or too }\DIFdelend \DIFaddbegin \DIFadd{is likely to be too }\DIFaddend big, but also because the evolution of the AOD could be
  inappropriate \DIFaddbegin \DIFadd{due to the aerosol size \mbox{%DIFAUXCMD
...
}\DIFaddend . To investigate this issue, our
...
\cite{mills2016}}\hskip0pt%DIFAUXCMD
  ...
  \DIFadd{We are using the coupled model version BWma1850 component setup to run the CESM2 with
...
. The
  ...
  and 15 November. \DIFaddbegin \note[reviewer2]{MC2} \DIFaddend The magnitudes vary over three orders of
  magnitude\DIFaddbegin \DIFadd{, or as introduced in \mbox{%DIFAUXCMD
\citeA{schmidt2022} }\hskip0pt%DIFAUXCMD
across volcano-climate index values
  \(3\) to \(6\)}\DIFaddend : \(\SI{26}{\tera\gram(\ce{SO2})}\), \(\SI{400}{\tera\gram(\ce{SO2})}\),
...
}\DIFdelend \DIFaddbegin \note[reviewer1]{L178} \DIFadd{The intermediate case, S400, resembles the magnitude of the
...
%DIFDELCMD <     altitudes?} %%%
\DIFdelend \DIFaddbegin \note[reviewer1]{L182} \DIFadd{injected from \(\SI{18}{\kilo\meter}\) to
  ...
  \(\SI{19.5}{\kilo\meter}\) and \(\SI{20.5}{\kilo\meter}\). }\DIFaddend Collectively, the four
  tropical eruption cases \DIFdelbegin \DIFdel{C2W\(\downarrow\), C2W\(-\), C2W\(\uparrow\), and C2W\(\uparrow\uparrow\) }\DIFdelend \DIFaddbegin \DIFadd{S26, S400, S1629, and S3000 }\DIFaddend are referred to as \DIFdelbegin \DIFdel{C2WTrop}\DIFdelend \DIFaddbegin \DIFadd{STrop}\DIFaddend . An
  additional high-latitude eruption ensemble, labelled \DIFdelbegin \DIFdel{C2WN\(\uparrow\)}\DIFdelend \DIFaddbegin \DIFadd{S1629N}\DIFaddend , of the same injected
...
\DIFdelendFL \DIFaddbeginFL \note[reviewer1]{Table 1} \DIFaddendFL Simulations done with the
...
\DIFdelendFL \DIFaddbeginFL \parbox{\linewidth}{\DIFaddFL{\(^{a}\)The ensembles S1629N and S1629
            ...
            of eruption months, while ensembles S1629N and S3000 consist of two members.}}\DIFaddendFL }
      \end{tabular}
    \end{center}
  \end{table*}
  ...
  }\DIFaddend arrives earlier for both AOD (Fig.~\ref{fig:1_compare_waveform}a) and \DIFdelbegin \DIFdel{temperature
  }\DIFdelend \DIFaddbegin \DIFadd{GMST
  }\DIFaddend (Fig.~\ref{fig:1_compare_waveform}c), \DIFdelbegin %DIFDELCMD < \annote[reviewer1]{while the RF time series in
...
\DIFdel{.Cases C2W\(-\), C2W\(\uparrow\), and C2W\(\uparrow\uparrow\) }\DIFdelend \DIFaddbegin \note[reviewer1]{L197} \DIFadd{while the normalised ERF
  time series in Fig.~\ref{fig:1_compare_waveform}b are all indistinguishable. Cases
  S400, S1629, and S3000 }\DIFaddend are indistinguishable in their \DIFdelbegin \DIFdel{temperature }\DIFdelend \DIFaddbegin \DIFadd{GMST }\DIFaddend development, and while \DIFdelbegin \DIFdel{C2W\(\downarrow\) }\DIFdelend \DIFaddbegin \DIFadd{S26
  }\DIFaddend peaks at an earlier time, it decays similarly to the other cases. Interestingly, the
  same development between \DIFdelbegin \DIFdel{C2W\(-\) and C2W\(\uparrow\) }\DIFdelend \DIFaddbegin \DIFadd{S400 and S1629 }\DIFaddend is not found in the AOD time series. \DIFdelbegin \DIFdel{C2W\(\downarrow\)
  }\DIFdelend \DIFaddbegin \DIFadd{S26 }\DIFaddend peaks
  at an earlier time, but also spends more time around the peak and as such decays at a
  later time post-eruption. Likewise, \DIFdelbegin \DIFdel{C2W\(-\) }\DIFdelend \DIFaddbegin \DIFadd{S400 }\DIFaddend has a faster rise and slower decay compared
  to \DIFdelbegin \DIFdel{C2W\(\uparrow\)}\DIFdelend \DIFaddbegin \DIFadd{S1629}\DIFaddend , but where both peak at a similar time. \DIFdelbegin \DIFdel{C2W\(\uparrow\)
...
\DIFdelend \DIFaddbegin \DIFadd{S1629 and S3000 have
  }\note[reviewer1]{L204} \DIFadd{similar normalised AOD developments}\DIFaddend , but where \DIFdelbegin \DIFdel{C2W\(\uparrow\uparrow\) }\DIFdelend \DIFaddbegin \DIFadd{S3000 }\DIFaddend show a
  ...
  simulation cases in table~\ref{tab:simulation-overview}; the small eruption case (\DIFdelbegin \DIFdel{C2W\(\downarrow\)}\DIFdelend \DIFaddbegin \DIFadd{S26}\DIFaddend )
  as blue downward-pointing triangles, the intermediate eruption case (\DIFdelbegin \DIFdel{C2W\(-\)}\DIFdelend \DIFaddbegin \DIFadd{S400}\DIFaddend ) as orange
  thick diamonds, the large tropical eruption case (\DIFdelbegin \DIFdel{C2W\(\uparrow\)}\DIFdelend \DIFaddbegin \DIFadd{S1629}\DIFaddend ) as green upward-pointing
  triangles, the extra large eruption case (\DIFdelbegin \DIFdel{C2W\(\uparrow\uparrow\)}\DIFdelend \DIFaddbegin \DIFadd{S3000}\DIFaddend ) as small pink upward-pointing carets,
  and the large northern hemisphere eruption case (\DIFdelbegin \DIFdel{C2WN\(\uparrow\)}\DIFdelend \DIFaddbegin \DIFadd{S1629N}\DIFaddend ) as brown upward-pointing
  ...
  Fig.~\ref{fig:2_rf_vs_aod_slopes}b highlights a narrow range, focusing on the \DIFdelbegin \DIFdel{C2W\(\downarrow\) }\DIFdelend \DIFaddbegin \DIFadd{S26
  }\DIFaddend case.

  The annual mean data from the Pinatubo-like \DIFdelbegin \DIFdel{C2W\(\downarrow\) }\DIFdelend \DIFaddbegin \DIFadd{S26 }\DIFaddend case in
  ...
  \begin{figure}
    ...
    %DIF >  FIXME: the P100 should be labelled J05 for consistency.
    \caption{\DIFdelbeginFL \DIFdelFL{RF }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{ERF }\DIFaddendFL as a function of AOD, yearly means. Data from the five simulations
      ...
      \DIFdelbeginFL \DIFdelFL{C2W\(\uparrow\uparrow\)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{S3000}\DIFaddendFL ) are shown along with the data from the HadCM3 sstPiHistVol simulation by
...
\DIFdelend \DIFaddbegin \note[reviewer1]{L269} \DIFadd{The post-peak period shows an
  ...
  an increasing efficiency, as expected. }\DIFaddend Likewise, the first three post-eruption years
  of the \DIFdelbegin \DIFdel{C2W\(-\), C2W\(\uparrow\uparrow\), and C2WN\(\uparrow\) }\DIFdelend \DIFaddbegin \DIFadd{S400, S3000, and S1629N }\DIFaddend cases show a weak negative slope and thus an increasing
  efficiency, while \DIFdelbegin \DIFdel{C2W\(\downarrow\) }\DIFdelend \DIFaddbegin \DIFadd{S26 }\DIFaddend shows an elevated post-peak ratio as seen in
  ...
  \begin{figure}
    \centering \DIFdelbeginFL %DIFDELCMD < \includegraphics{figure3}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.49\linewidth]{figure3-alt}
\DIFaddendFL 
...
\DIFdelendFL \DIFaddbeginFL \note[reviewer1]{Figure 3}\DIFaddendFL (a): The ratio of \DIFdelbeginFL \DIFdelFL{RF }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{ERF }\DIFaddendFL to AOD, with
      ...
      table~\ref{tab:simulation-overview} along with tropical eruptions from M20. \DIFaddbeginFL \DIFaddFL{Values
      ...
      year.}\DIFaddendFL }\label{fig:3_rf_to_aod_ratios}%
  \end{figure}
...
\citeA{timmreck2010} }\hskip0pt%DIFAUXCMD
labelled }\DIFdelend \DIFaddbegin \DIFadd{, E13, }\DIFaddend T10\DIFdelbegin \DIFdel{. The J05 is a simulation of a super-volcano based on a \(100\) times scaling of the AOD from Mt. \
  Pinatubo, while T10 is a simulation of the YTT eruption based on \ce{SO2} injections}\DIFdelend \DIFaddbegin \DIFadd{, Os20) show
  ...
  absolute value of \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend on the \(y\)-axis) indicates a substantial damping effect on \DIFdelbegin \DIFdel{RF
  }\DIFdelend \DIFaddbegin \DIFadd{ERF
  }\DIFaddend as injected \ce{SO2} increases for the \DIFdelbegin \DIFdel{C2W }\DIFdelend \DIFaddbegin \DIFadd{STrop }\DIFaddend data, in agreement with results from
  \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citeA{ottobliesner2016}}\hskip0pt%DIFAUXCMD
, labelled }\DIFdelend OB16. The OB16 data come from a \(2500\) year long simulation using historic volcanoes
  ...
  (CESM1) with a low-top atmosphere (CAM5) produce \DIFdelbegin \DIFdel{RFs }\DIFdelend \DIFaddbegin \DIFadd{ERFs }\DIFaddend comparable to our findings. \DIFaddbegin \DIFadd{Both
  ...
  lower end of their simulations, which is shown by \mbox{%DIFAUXCMD
...
\DIFdelendFL \DIFaddbeginFL \note[reviewer1]{Fig. 4}\DIFaddFL{Peak values of }\DIFaddendFL (a) AOD, (b) \DIFdelbeginFL \DIFdelFL{RF}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{ERF}\DIFaddendFL , and (c) \DIFdelbeginFL \DIFdelFL{temperature
      anomaly }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{GMST }\DIFaddendFL as a
      function of injected \ce{SO2}\@. (d) \DIFdelbeginFL \DIFdelFL{RF }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{ERF }\DIFaddendFL and (e) \DIFdelbeginFL \DIFdelFL{temperature anomaly
      }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{GMST }\DIFaddendFL as a function of AOD. (f)
      \DIFdelbeginFL \DIFdelFL{Temperature anomaly }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{GMST }\DIFaddendFL as a function of \DIFdelbeginFL \DIFdelFL{RF}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{ERF}\DIFaddendFL . Blue diamonds labelled \DIFdelbeginFL \DIFdelFL{C2WTrop }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{STrop }\DIFaddendFL represent tropical cases
      (\DIFdelbeginFL \DIFdelFL{C2W\(\downarrow\)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{S26}\DIFaddendFL , \DIFdelbeginFL \DIFdelFL{C2W\(-\)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{S400}\DIFaddendFL , \DIFdelbeginFL \DIFdelFL{C2W\(\uparrow\)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{S1629}\DIFaddendFL , \DIFdelbeginFL \DIFdelFL{C2W\(\uparrow\uparrow\)}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{S3000}\DIFaddendFL ), the brown three-branched twig signifies the \DIFdelbeginFL \DIFdelFL{C2WN\(\uparrow\) }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{S1629N
      }\DIFaddendFL case, and green downward triangles denote OB16 \DIFdelbeginFL \DIFdelFL{data from
      \mbox{%DIFAUXCMD
\citeA{ottobliesner2016}}\hskip0pt%DIFAUXCMD
}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{while green upward triangles denote
      B20}\DIFaddendFL . The \DIFaddbeginFL \DIFaddFL{pink square is J05 and the }\DIFaddendFL red thin diamonds \DIFdelbeginFL \DIFdelFL{labelled }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{are }\DIFaddendFL M20\DIFdelbeginFL \DIFdelFL{display the
      \mbox{%DIFAUXCMD
\citeA{marshall2020dataset} }\hskip0pt%DIFAUXCMD
data}\DIFdelendFL . \DIFaddbeginFL \DIFaddFL{McG24 and Os20 are
      indicated by purple upward twigs and orange diamonds, while pink circle and dashed
      line represent T10 and N15. }\DIFaddendFL Black star and plus indicate Mt.\ Pinatubo and
      Mt.\ Tambora estimates based on observations\DIFdelbeginFL \DIFdelFL{. The pink square labelled J05 refers
...
\citeA{jones2005}}\hskip0pt%DIFAUXCMD
      ...
      \mbox{%DIFAUXCMD
\citeA{timmreck2010}}\hskip0pt%DIFAUXCMD
}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{brown thin diamonds denote E13}\DIFaddendFL .
      \DIFdelbeginFL \DIFdelFL{The pink dashed line labelled N15 is from
      \mbox{%DIFAUXCMD
\citeA{niemeier2015}}\hskip0pt%DIFAUXCMD
, indicating }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Note that all }\DIFaddendFL the \DIFdelbeginFL \DIFdelFL{function }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{data points }\DIFaddendFL in \DIFdelbeginFL \DIFdelFL{Eq}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{the legend do not provide all four parameters,
      and are thus not part of every subfigure}\DIFaddendFL .\DIFdelbeginFL \DIFdelFL{~\ref{eq:niemeier_exponential}.}\DIFdelendFL }\label{fig:4_parameter_scan}%
  \end{figure*}
...
\DIFdelend \begin{equation}
  ...
  relationship. }\DIFdelend The results by N15, on which Eq.~\ref{eq:niemeier_exponential} is based, are all
  averages over at least three years of steady sulphur burdens, substantially longer
  than the time it takes for \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend to reach peak values after an eruption. Combined with
  ...
  boundary defined by \DIFdelbegin \DIFdel{C2WTrop }\DIFdelend \DIFaddbegin \DIFadd{STrop }\DIFaddend and OB16, and a lower boundary defined by
  ...
  tend to yield weaker peak \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend values, closer to the lower boundary. Importantly, none
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \note[reviewer1]{L338} \DIFadd{we do not focus on the M20
  ...
  }\DIFdelend \DIFaddbegin \DIFadd{STrop }\DIFaddend data
  decreases with \DIFdelbegin \DIFdel{injected \ce{SO2}}\DIFdelend \DIFaddbegin \DIFadd{increasing AOD}\DIFaddend , this time in \DIFdelbegin \DIFdel{temperature }\DIFdelend \DIFaddbegin \DIFadd{GMST }\DIFaddend anomaly. Additionally, both \DIFdelbegin \DIFdel{the C2WN\(\uparrow\) and the J05 cases }\DIFdelend \DIFaddbegin \DIFadd{S1629N
  and B20 }\DIFaddend align well with \DIFdelbegin \DIFdel{C2WTrop, with the }\DIFdelend \DIFaddbegin \DIFadd{STrop, with }\DIFaddend T10\DIFdelbegin \DIFdel{case
  }\DIFdelend \DIFaddbegin \DIFadd{, and J05 and Os20 }\DIFaddend following a similar
  dependence\DIFaddbegin \DIFadd{, albeit somewhat weaker and stronger, respectively}\DIFaddend .

  Finally, in Fig.~\ref{fig:4_parameter_scan}f, we compare the \DIFdelbegin \DIFdel{temperature and RF
  }\DIFdelend \DIFaddbegin \DIFadd{GMST and ERF }\DIFaddend responses.
  Both \DIFdelbegin \DIFdel{C2WTrop }\DIFdelend \DIFaddbegin \DIFadd{STrop }\DIFaddend and OB16 show a near-linear relationship between \DIFdelbegin \DIFdel{temperature
  and RF. The C2WTrop }\DIFdelend \DIFaddbegin \DIFadd{GMST and ERF. The STrop
  }\DIFaddend data indicate a steeper slope, implying stronger \DIFdelbegin \DIFdel{temperature
  }\DIFdelend \DIFaddbegin \DIFadd{GMST }\DIFaddend perturbations as compared to
  ...
  results in the analysis of OB16 \DIFdelbegin \DIFdel{temperature }\DIFdelend \DIFaddbegin \DIFadd{GMST }\DIFaddend anomalies being less reliable. \DIFdelbegin \DIFdel{As in Fig.~\ref{fig:4_parameter_scan}e, the C2WN\(\uparrow\) case along
  with both the T10 and }\DIFdelend \DIFaddbegin \DIFadd{All other cases
  (S1629N, }\DIFaddend J05\DIFdelbegin \DIFdel{cases }\DIFdelend \DIFaddbegin \DIFadd{, T10, B20, McG24) }\DIFaddend closely follow the \DIFdelbegin \DIFdel{temperature to RF dependence of
  C2WTrop}\DIFdelend \DIFaddbegin \DIFadd{linear GMST to ERF dependence of
  STrop}\DIFaddend .

  The almost linear relationship between AOD and injected \ce{SO2} for the \DIFdelbegin \DIFdel{C2WTrop }\DIFdelend \DIFaddbegin \DIFadd{STrop }\DIFaddend data in
  Fig.~\ref{fig:4_parameter_scan}a suggests a comparable trend for \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend versus injected
  \ce{SO2} in Fig.~\ref{fig:4_parameter_scan}b, as seen for \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend versus AOD in
  Fig.~\ref{fig:4_parameter_scan}d. For the same reason, we expect
  Fig.~\ref{fig:4_parameter_scan}e to show a similar pattern for \DIFdelbegin \DIFdel{C2WTrop }\DIFdelend \DIFaddbegin \DIFadd{STrop }\DIFaddend as observed in
  ...
  \DIFdelbegin %DIFDELCMD < \annote[reviewer1]{\protect(\(ax+b\)), and of temperature on RF (\(cx+d\))}{It seems
...
\DIFdelend \DIFaddbegin \annote[reviewer1]{\protect(\(ax+b\)), and of GMST on ERF (\(cx+d\))}{It seems as if x
    ...
    detail.}\DIFaddend , we must have that \(f\), \(g\), \(h\), and \(k\) all have the same
  functional form, where \DIFdelbegin \DIFdel{\(f: \ce{SO2} \to \mathrm{RF}\)}\DIFdelend \DIFaddbegin \DIFadd{\(f: \ce{SO2} \to \mathrm{ERF}\)}\DIFaddend , \(g: \mathrm{AOD} \to
  \mathrm{T}\), \(h: \ce{SO2} \to \mathrm{T}\), and \DIFdelbegin \DIFdel{\(k: \mathrm{AOD} \to \mathrm{RF}\)}\DIFdelend \DIFaddbegin \DIFadd{\(k: \mathrm{AOD} \to
  \mathrm{ERF}\)}\DIFaddend . From this, we deduce that \(f(x)=k(ax+b)\) and
  ...
  \begin{figure}
    ...
    \DIFdelbeginFL %DIFDELCMD < \begin{tikzpicture}[>={Stealth[length=1mm,width=2mm]}]
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \begin{tikzpicture}[>={Stealth[length=1mm,width=2mm]}]
...
\DIFdel{, a duration too short }\DIFdelend \DIFaddbegin \note[reviewer1]{L378} \DIFadd{As the forcing of volcanic eruptions last for too short time
  ...
  }\DIFaddend perturbation obtained by J05 was larger than in any of our CESM2 cases, it indicates
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \note[reviewer1]{L398} \DIFadd{The peak value
  ...
  aerosol effective radius. \mbox{%DIFAUXCMD
\citeA{mcgraw2024} }\hskip0pt%DIFAUXCMD
find that from supereruptions, it is
  possible to achieve even a warming of the GMST. However, as our model results align
  well with the results of \mbox{%DIFAUXCMD
\citeA{mcgraw2024} }\hskip0pt%DIFAUXCMD
using a small aerosol effective radius of
  ...
  perturbation of \mbox{%DIFAUXCMD
\citeA{jones2005} }\hskip0pt%DIFAUXCMD
is too extreme.
}\DIFaddend 
...
, resulting in an increased AOD peak value and \(e\)-folding time
  \mbox{%DIFAUXCMD
\cite{zanchettin2016,clyne2021}}\hskip0pt%DIFAUXCMD
. Thus, the sublinear relationship for AOD and ERF to
  ...
  gravitational pull, substantially impacting both AOD and \DIFdelbegin \DIFdel{RF evolution, is }\DIFdelend \DIFaddbegin \DIFadd{ERF evolution, as }\DIFaddend highlighted
  ...
  of the \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend to AOD ratio. However, latitude and, in particular, aerosol dispersion are
  ...
  linear \DIFdelbegin \DIFdel{temperature dependency on RF, with the }\DIFdelend \DIFaddbegin \DIFadd{GMST dependency on ERF, with S1629N, }\DIFaddend J05, T10, \DIFdelbegin \DIFdel{and C2WN\(\uparrow\)
  }\DIFdelend \DIFaddbegin \DIFadd{B20, and McG24 all }\DIFaddend aligning
  close to the same slope. The linear relationship between \DIFdelbegin \DIFdel{temperature and RF
  ...
  \mbox{%DIFAUXCMD
\citeA{english2013} }\hskip0pt%DIFAUXCMD
who suggested that large eruptions can be self-limiting}\DIFaddend .
  ...
  injected \ce{SO2} increases, both AOD, \DIFdelbegin \DIFdel{RF, and temperature }\DIFdelend \DIFaddbegin \DIFadd{ERF, and GMST }\DIFaddend across models have a big spread.
  ...
  Comparatively, the \DIFdelbegin \DIFdel{RF
  }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend (Fig.~\ref{fig:4_parameter_scan}d) and \DIFdelbegin \DIFdel{temperature }\DIFdelend \DIFaddbegin \DIFadd{GMST
  }\DIFaddend (Fig.~\ref{fig:4_parameter_scan}e) as a function of AOD, as well as \DIFdelbegin \DIFdel{temperature }\DIFdelend \DIFaddbegin \DIFadd{GMST }\DIFaddend as a function
  of \DIFdelbegin \DIFdel{RF
  }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend (Fig.~\ref{fig:4_parameter_scan}f), demonstrate a smaller spread across models.
  ...
  the estimated AOD and \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend magnitudes from injected \ce{SO2}, whereas the various
  models generally demonstrate more consistency in representing \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend from AOD.
  ...
  results, as illustrated in Fig.~\ref{fig:1_compare_waveform}a, where \DIFdelbegin \DIFdel{C2W\(\downarrow\)
  }\DIFdelend \DIFaddbegin \DIFadd{S26 }\DIFaddend shows an
  earlier AOD peak compared to \DIFdelbegin \DIFdel{C2W\(-\), C2W\(\uparrow\), and C2W\(\uparrow\uparrow\)}\DIFdelend \DIFaddbegin \DIFadd{S400, S1629, and S3000}\DIFaddend . While the peak \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend value of T10
  occurs \(7\)--\(8\) months post-eruption, similar to \DIFdelbegin \DIFdel{C2W}\DIFdelend \DIFaddbegin \DIFadd{STrop}\DIFaddend , the J05 peak anomaly
  ...
  climate model and larger than the climate resistance obtained here from \DIFdelbegin \DIFdel{C2W}\DIFdelend \DIFaddbegin \DIFadd{STrop}\DIFaddend , we
  conclude that \DIFdelbegin \DIFdel{such a simple approach of
...
}\DIFdelend \DIFaddbegin \DIFadd{their estimated GMST is likely too extreme.
}\DIFaddend 
...
\DIFdelend During analysis, one outlier was found in the ensemble representing \DIFdelbegin \DIFdel{C2W\(\downarrow\)}\DIFdelend \DIFaddbegin \DIFadd{S26}\DIFaddend , specifically
  ...
  \begin{table*}
    ...
    \begin{tabular}{ccc}
      ...
      & ECHAM5 & N15 \\
      & MPI-ESM & T10 \\
      \DIFaddbeginFL \DIFaddFL{GISS-E2.1 }& \DIFaddFL{GISS-E2.1 }& \DIFaddFL{Os20, McG24 }\\
      \DIFaddendFL \toprule
...
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \bibliography{/home/een023/science/ref/ref}
\DIFaddend 
