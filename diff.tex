...
%DIF ADD ./agujournaltemplate.tex                             Tue Aug 27 09:36:39 2024
...
\DIFdelend \DIFaddbegin \note[reviewer1]{L15}
    ...
    bounding the GMST to at most \(\sim\SI{-12}{\kelvin}\). }\DIFaddend When including the results
...
\DIFdelend \DIFaddbegin \note[reviewer1]{L33} \DIFadd{energy balance at the top of the atmosphere when
  ...
  % FIXME: related to this, there is an index that can be added during publishing. Find
  % the list here:
...
\cite<e.g.~>[]{zanchettin2019,marshall2020,marshall2022,mcgraw2024}}\hskip0pt%DIFAUXCMD
  ...
  eruptions. While \citeA{myhre2013} employ a formula scaling \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend by AOD to obtain
...
%DIFDELCMD <     brackets on these numbers.} %%%
\DIFdelend \DIFaddbegin \note[reviewer1]{L94}{\(\SI{-19.0(5)}{\watt\metre^{-2}\mathrm{AOD}^{-1}}\)}
  \DIFaddend \annote[reviewer1]{\protect\cite{gregory2016} and
    \(\SI{-18.3(10)}{\watt\metre^{-2}\mathrm{AOD}^{-1}}\) \cite{mills2017}}{These are
    stratospheric aerosol simulations, not volcano simulations.}. Synthetic volcano
  simulations in \citeA{marshall2020} yield a scaling factor of
...
\DIFdelend \DIFaddbegin \DIFadd{S1629 and S3000 have
  ...
  \DIFdelbegin \DIFdel{better highlight C2WN\(\uparrow\)}\DIFdelend %DIF >  FIXME: when deciding which figure to use, update the below [Fig 3a or Fig3]
  \DIFaddbegin \DIFadd{better highlight S1629N}\DIFaddend . In Fig.~\ref{fig:3_rf_to_aod_ratios}a, lines are linear
  ...
  but where the regression fits have been omitted for clarity. As the AOD and \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend time
  ...
  a pre-peak period where the peak of both the AOD and the \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend is included (consisting
...
\citeA{timmreck2010} }\hskip0pt%DIFAUXCMD
labelled }\DIFdelend \DIFaddbegin \DIFadd{, }\DIFaddend T10\DIFdelbegin \DIFdel{. The J05 is a simulation of a super-volcano based on a \(100\) times scaling of the AOD from Mt.
\
  Pinatubo, while T10 is a simulation of the YTT eruption based on \ce{SO2} injections.
}\DIFdelend \DIFaddbegin \DIFadd{, E13, B20, Os20)
  ...
  \citeA{ottobliesner2016}, labelled OB16. The OB16 data come from a \(2500\) year long
  ...
  complexity difference, \citeA{ottobliesner2016}'s simulations using Community Earth
  System Model version 1 (CESM1) with a low-top atmosphere (CAM5) produce \DIFdelbegin \DIFdel{RFs }\DIFdelend \DIFaddbegin \DIFadd{ERFs
  }\DIFaddend comparable to our findings. \DIFaddbegin \DIFadd{Both B20 and McG24 align well with STrop, and while B20
...
\DIFdelendFL \DIFaddbeginFL \note[reviewer1]{Fig. 4}\DIFaddFL{Peak values of }\DIFaddendFL (a) AOD, (b) \DIFdelbeginFL \DIFdelFL{RF}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{ERF}\DIFaddendFL , and (c) \DIFdelbeginFL \DIFdelFL{temperature
      ...
      }\DIFaddendFL case, and green downward triangles denote OB16 data from \citeA{ottobliesner2016}.
      The red thin diamonds labelled M20 display the \citeA{marshall2020dataset} data.
      ...
      Mt.\ Pinatubo super-volcano from \citeA{jones2005}, and the pink disk labelled T10
      represents the YTT super-volcano from \citeA{timmreck2010}. The pink dashed line
      labelled N15 is from \citeA{niemeier2015}, indicating the function in
...
\DIFdelend \DIFaddbegin \note[reviewer1]{L338} \DIFadd{we do not focus on the M20
  ...
  (S1629N, }\DIFaddend J05\DIFdelbegin \DIFdel{cases }\DIFdelend \DIFaddbegin \DIFadd{, T10, B20, McG24) }\DIFaddend closely follow the \DIFdelbegin \DIFdel{temperature to RF dependence of C2WTrop}\DIFdelend \DIFaddbegin \DIFadd{GMST to ERF dependence of STrop}\DIFaddend .
...
. Thus, the sublinear relationship for AOD and ERF to
  ...
  gravitational pull, substantially impacting both AOD and \DIFdelbegin \DIFdel{RF }\DIFdelend \DIFaddbegin \DIFadd{ERF }\DIFaddend evolution, is highlighted
  ...
  we expect \DIFdelbegin \DIFdel{temperature }\DIFdelend \DIFaddbegin \DIFadd{GMST }\DIFaddend anomalies to reach at most \(\sim\SI{-12}{\kelvin}\)\DIFaddbegin \DIFadd{, in support of
  \mbox{%DIFAUXCMD
\citeA{english2013} }\hskip0pt%DIFAUXCMD
