\begin{acronym}[AODVISstdn]
  ...
  \acro{c2wmp}[C2W\(-\)]{CESM2(WACCM6) intermediate strength}

  \acro{c2wm}[C2W\(\downarrow\)]{CESM2(WACCM6) small strength}

  \acro{c2wsn}[C2WN\(\uparrow\)]{CESM2(WACCM6) large strength, high northern latitude}
