...
% TODO:
% 1. Question at the top is not answered. Is AOD or RF more influential?
% 2. Update the general text comparing shape of RF to T. Does it make sense to say they are strongly related?
% 3. Make a point out of the faster decay of AOD and RF compared to T, which is heavily perturbed still after several years
...
% NOTE: can add that the strongest feature in this fig and fig3 is that different eruption strength has different ratio. Compared to other eruption strengths, any ratio may seem roughly constant, but focusing on a single strength there is a clear aod forcing efficiency decrease for tropical eruptions.
...
%To find the development of \gls{aod} and \gls{rf} relative to each other over time, we plot in Fig.~\ref{fig:aod_vs_toa_avg_loop_ratios} seasonal means of the \gls{rf} to \gls{aod} ratio,
