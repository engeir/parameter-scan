...
study is based on ensemble simulations in the \gls{cesm2} climate model coupled to the
...
\begin{figure}
  ...
  \caption{\gls{rf} as a function of \gls{aod}, yearly means. Data from the four
    ...
    values of the Mt.\ Pinatubo (black star) and Mt.\ Tambora (black plus) eruptions. In
