...
\begin{table}
  ...
  \begin{center}
    \begin{tabular}[c]{cccc}
      \textbf{Name}                & \textbf{\ce{SO2}}                   & \textbf{Lat, lon, alt} &
      \textbf{Eruption months}                                                                      \\
      \gls{c2wsn}                  & \(\SI{1629}{\tera\gram(\ce{SO2})}\) &
      \SI{56}{\degree\mathrm{N}}, \SI{1}{\degree\mathrm{E}},
      \(18\)--\SI{20}{\kilo\metre} & Feb,Aug                                                        \\
      \gls{c2ws}                   & \(\SI{1629}{\tera\gram(\ce{SO2})}\) &
      \SI{0}{\degree\mathrm{N}}, \SI{1}{\degree\mathrm{E}}, \(18\)--\SI{20}{\kilo\metre}
                                   & Feb,May,Aug,Nov                                                \\
      \gls{c2wmp}                  & \(\SI{400}{\tera\gram(\ce{SO2})}\)  &
      \SI{0}{\degree\mathrm{N}}, \SI{1}{\degree\mathrm{E}},
