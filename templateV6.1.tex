...
The \gls{m20} data is briefly described in Appendix B, section~\ref{ap:m20}.
...
estimate from an initial injection of \ce{SO2} which resulted in a delayed peak but also
...
aerosol forcing efficiency as the injection rate increases, connected to larger volcanic
eruptions leading to larger aerosol particle sizes, thereby decreasing the forcing
efficiency per \iso{} \citep{english2013, timmreck2018}.
