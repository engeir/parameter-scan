...
to develop as the amount of injected \ce{SO2} increases
...
for their \(\SI{1700}{\tera\gram}\) \ce{SO2} eruption, while the opposite is the case
...
more \ce{SO2} is injected creates larger aerosols which are less effective at scattering
