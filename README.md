...
> [!TIP]
>
> [_View the generated PDF at the latest release!_](https://github.com/engeir/parameter-scan/releases/download/v0.6.0/templateV6.1.pdf) <!-- x-release-please-version -->
<!-- dprint-ignore-end -->
