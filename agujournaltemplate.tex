...
\begin{document}
  ...
  \begin{abstract}
    ...
    anomalies. Unlike the traditional linear model used for smaller eruptions, a
    non-linear relationship is typically found between ERF and AOD for larger eruptions.
    We further uncover a notable time-dependent decrease in aerosol forcing efficiency
    (ERF normalised by AOD) across all eruption magnitudes during the first
    post-eruption year. In addition, the study reveals that the largest as compared to
    Pinatubo-sized eruption events produce a delayed and sharper peak in AOD, and a
    longer-lasting GMST response while the time evolution of ERF remains similar between
    the two eruption types. We find that the peak ERF approaches a limiting value, and
    that the peak GMST response follows linearly, effectively bounding the GMST to at
    most \(\sim\SI{-12}{\kelvin}\). When including the results of previous studies, we
    find that relating \ce{SO2} to any other parameter is inconsistent across models
    compared to the relationships between AOD, ERF, and GMST. Thus, we expect the
    largest uncertainty in model codes to relate to \note[reviewer1]{L25} the chemistry
    and physics of aerosol evolution.
  \end{abstract}
  ...
  relationship between the ERF energy imbalance and change in AOD caused by volcanic
  eruptions. While \citeA{myhre2013} employ a formula scaling ERF by AOD to obtain
  \(\SI{-25}{\watt\metre^{-2}\mathrm{AOD}^{-1}}\), recent literature reports estimates
  down to \note[reviewer1]{L94}{\(\SI{-19.0(5)}{\watt\metre^{-2}\mathrm{AOD}^{-1}}\)}
  \annote[reviewer1]{\protect\cite{gregory2016} and
  ...
  % FIXME: when deciding which figure to use, update the below [Fig 3a or Fig3]
  ...
  values from other simulations of large \ce{SO2} magnitudes (J05, T10, E13, B20, Os20)
  ...
  \citeA{mcgraw2024} to produce the most extreme ERF and GMST perturbations.
  ...
  \begin{figure*}
    ...
    \caption{\note[reviewer1]{Fig. 4}Peak values of (a) AOD, (b) ERF, and (c) GMST as a
      ...
      case, and green downward triangles denote OB16 data from \citeA{ottobliesner2016}.
  ...
  \bibliography{/home/een023/science/ref/ref}
