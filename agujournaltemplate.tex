...
% FIXME: they do not allow `newcommand`, and escpecially not commands using `#`, so this needs to be updated.
...
% FIXME: footnotes in the text is not allowed
...
\begin{acronyms}
  ...
  Version 3 \acro{YTT} Young Toba Tuff
\end{acronyms}
