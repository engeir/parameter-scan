...
across all tropical eruptions. Similar to the results of \citeA{marshall2020}, we find
...
\begin{acronyms}
  \acro{AODVISstdn} ``stratospheric aerosol optical depth 550 nm day night'' \acro{AOD}
  stratospheric aerosol optical depth \acro{CAM5} Community Atmosphere Model Version 5
  \acro{CESM1} Community Earth System Model Version 1 \acro{CESM2} Community Earth
  System Model Version 2 \acro{ECS} equilibrium climate sensitivity \acro{ERF} effective
  radiative forcing \acro{FLNT} ``net longwave flux at the top of the model''
  \acro{FSNT} ``net solar flux at the top of the model'' \acro{IRF} instantaneous
  radiative forcing \acro{MAM3} three mode version of the Modal Aerosol Module \acro{MA}
  middle atmosphere \acro{POP2} Parallel Ocean Program Version 2 \acro{RF} effective
