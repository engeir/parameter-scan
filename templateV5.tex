...
(\acrshort{saod}) and \acrshort{rf}, but there, the efficiency increases from year 1 to
year 2, while here efficiency decreases with time. \citet{marshall2020} explain that
this is due to the time it takes for the aerosols to spread which affects the global
albedo and in turn the \acrshort{rf}, while the \acrshort{aod} being less affected by
the aerosols spreading.
...
versus \(\sim-10\) to \(\sim-4\)). It has been shown that that efficiency decrease as
