...
\begin{itemize}
  ...
  \item Argue that the temperature response might be more sensitive to the sign of the forcing,
        rather than the forcing agent, and as such that a halving of \ce{CO2} should be
        compared with volcanoes \citep{gunther2022}
  \item How important is it the \ce{SO2} is injected at a given height?
\end{itemize}
