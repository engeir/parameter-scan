...
\begin{description}
  ...
  \item[eruptions] \citet{arfeuille2014, douglass2006, kleinschmitt2018, marshall2019,
      marshall2020, marshall2021, niemeier2017, soden2002, sukhodolov2018, tilmes2017}
...
largest ratio is from the small eruption, is consistent with the change in peak values
...
the early phase seem to have a \acrshort{aod} to \acrshort{toa} ratio that changes (from
...
When plotting the \acrshort{toa} time series we find that their shape is very consistent
...
% FIX: I am no longer using the C1C data.
...
\begin{figure}
  ...
  \caption{\acrshort{aod} versus \acrshort{toa}}%
