...
\begin{figure}
  \begin{subfigure}{\linewidth}
    \centering
    \includegraphics[width=0.95\linewidth]{figures/aod_arrays_normalised}
    \caption{}%
    \label{fig:aod_arrays_normalised}
  \end{subfigure}
  \begin{subfigure}{\linewidth}
    \centering
    \includegraphics[width=0.95\linewidth]{figures/toa_arrays_normalised}
    \caption{}%
    \label{fig:toa_arrays_normalised}
  \end{subfigure}

  \caption{The \ac{aod} time series (\subref{fig:aod_arrays_normalised}) and \ac{rf} time
    series (\subref{fig:toa_arrays_normalised}) from the simulations summarised in
