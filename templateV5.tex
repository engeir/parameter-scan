...
Radiative forcing is calculated as the difference in the net \( \acrshort{fsnt} +
\acrshort{flnt} \) all-sky \acrshort{toa} energy imbalance between volcanic simulations
and a control simulation (definition as in \citet{marshall2020}). The \acrshort{cesm2}
...
\cref{fig:so2_vs_toa} than the \acrshort{waccm} simulations.)
